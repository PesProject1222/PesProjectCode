...
void resetVerticaal() {
  float verschil = 0.0 - huidigeHoek;
  verticaalMotor.draai(verschil / 360.0);
  huidigeHoek = 0.0;
}
...
void mikkenOpHoek() {
  ...
  float verschil = besteHoek - huidigeHoek;
  verticaalMotor.draai(verschil / 360.0);
  huidigeHoek = besteHoek;

  Serial.print("Stappenmotor gericht op ");
